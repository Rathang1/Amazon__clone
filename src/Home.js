  ...
  return <div className="home">
      <div className='home__container'>
         ...
         <div className='home__row'>
            ...
            <Product 
            id = "123457"
            title = 'Newest Playstation 5 Disc Version PS5 Console with One Wireless Controller, 4K-TV Gaming, 16GB GDDR6 RAM, 8K Output, WiFi 6. Ultra-High Speed 825GB SSD - LPT Ultra High Speed HDMI Cable' 
            price ={960} 
         ...
         <div className='home__row'>
            ...
            <Product 
            id = "123460"
            title = 'Lamborghini Sian FKP 37 Red with Copper Wheels 118 Diecast' 
            price ={100000} 
